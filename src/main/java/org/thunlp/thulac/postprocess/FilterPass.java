...
public class FilterPass implements IPostprocessPass {
    ...
    private String xuDatFile;
    private String timeDatFile;
    ...
    public FilterPass(String xuDatFile, String timeDatFile) throws IOException {
        ...
        this.xuDatFile = xuDatFile;
        this.timeDatFile = timeDatFile;
    }
    ...
    public boolean equals(Object o) {
        ...
        FilterPass that = (FilterPass) o;
        return Objects.equals(xuDatFile, that.xuDatFile) &&
                Objects.equals(timeDatFile, that.timeDatFile);
    }

    @Override
    public int hashCode() {
        return Objects.hash(xuDatFile, timeDatFile);
    }
}
