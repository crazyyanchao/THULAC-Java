...
public class ThulacTest {
    ...
    private static String TEXT = "5月14日消息，据国外媒体报道，在宣布将暂停接受比特币支付一天后，电动汽车制造商特斯拉CEO埃隆·马斯克（Elon Musk）于当地时间周四在推特上表示，他正在与狗狗币的开发人员合作，以提高系统交易效率。\n" +
    ...
    @Test
    public void splist_6() throws IOException {
        //用户指定的字典的可选文件名
        String userDict = "dic/user_defined.dic";
        //是否将繁体中文转为简体中文
        boolean useT2S = true;
        ...
        List<TaggedWord> result = Thulac.split("今年春天，奶奶家阳台上的花盆里不知怎么的，冒出了两株苦瓜树，我可从来没见过苦瓜树，忽然，一个想法在我脑海中隐隐出现了。为了观察苦瓜树，我每天中午一放了学就去奶奶家认真打量它。\n" +
                "\n" +
                "\n" +
                "\n" +
                "　　苦瓜树刚长出来的叶子是嫩绿的，上面长着一根白色的毛绒绒的小毛毛，没几天，叶子长大就变成碧绿的了，苦瓜树的叶子跟爬山虎的叶子长得很像，但苦瓜的叶子相对来说要比爬山虎的叶子软。\n" +
                ...
                "\n" +
                "\n" +
                "　　啊!好漂亮的一株苦瓜呀!", userDict, useT2S, useFilter);
        result.forEach(v-> System.out.println(v.getWord()+"--------"+v.getTag()+"----------"+v.getDescription()));
    }
}
